...
--
-- Host: 127.0.0.1    Database: benjamin_finalproject
-- ------------------------------------------------------
...
CREATE TABLE `supplyinfo` (
  ...
  `DeliveryNotes` varchar(600) NOT NULL,
...
INSERT INTO `supplyinfo` VALUES (1,'LUCAS LLC','Supply clothing'),(2,'JUDAS','Supply Lottery Cards'),(3,'LEWIS LLC','Book Supplier'),(4,'Houston Electronics','Supplies Electrical and Computers'),(5,'fintech','Supply Computers');
...
-- Dump completed on 2022-08-07 18:47:31
